...
TEST(RobotState, CanBeStreamed) {
  ...
  EXPECT_PRED2(stringContains, output, "accelerometer_top_x");
  EXPECT_PRED2(stringContains, output, "accelerometer_top_y");
  EXPECT_PRED2(stringContains, output, "accelerometer_top_z");
  EXPECT_PRED2(stringContains, output, "accelerometer_bottom_x");
  EXPECT_PRED2(stringContains, output, "accelerometer_bottom_y");
  EXPECT_PRED2(stringContains, output, "accelerometer_bottom_z");
