...
.. code-block:: bash
   ...
   wget https://github.com/frankarobotics/libfranka/releases/download/0.18.2/libfranka_0.18.2_jammy_amd64.deb
   sudo dpkg -i libfranka_0.18.2_jammy_amd64.deb

**For Ubuntu 24.04 (Noble):**

.. code-block:: bash

   wget https://github.com/frankarobotics/libfranka/releases/download/0.18.2/libfranka_0.18.2_noble_amd64.deb
   sudo dpkg -i libfranka_0.18.2_noble_amd64.deb
...
.. code-block:: bash
   ...
   wget https://github.com/frankarobotics/libfranka/releases/download/0.18.2/libfranka_0.18.2_focal_amd64.deb.sha256

   # Verify integrity
   sha256sum -c libfranka_0.18.2_focal_amd64.deb.sha256
...
.. code-block:: bash
   ...
   cd libfranka
   git checkout 0.18.2  # or your desired version
...
.. code-block:: text
   ...
   /usr/lib/libfranka.so -> libfranka.so.0.18.2
...
.. code-block:: text
   ...
   ii  libfranka  0.18.2  amd64  libfranka - Franka Robotics C++ library
